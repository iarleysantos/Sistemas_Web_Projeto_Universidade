...
public class ProfessorDAO {
    ...
    // Buscar professores aptos para uma disciplina específica (Item 2.e)
    public List<Professor> listarAptosPorDisciplina(String codigoDisciplina) throws Exception {
